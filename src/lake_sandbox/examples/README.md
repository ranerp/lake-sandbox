...
This directory contains examples demonstrating how to analyze the timeseries data generated by the lake-sandbox pipeline using DuckDB and create visualizations.

## Overview

After running the lake-sandbox pipeline, your data will be stored in DeltaLake format at `output/timeseries-delta/`. These examples show how to:
